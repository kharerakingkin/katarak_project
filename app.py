...
if not FACE_CASCADE or not EYE_CASCADE:
    st.warning("‼️ Fungsionalitas **Auto Zoom dinonaktifkan** karena kegagalan memuat file Haar Cascade XML. Harap periksa folder `cascades` dan pastikan dependensi sistem.")
